    ...
    <SectionBasic title="REVISTA ESCPOGRA" {...PROPS_SECTION}>
      <Container>
        <section className="section-text">
          <div className="content-post">
            <p>
              ...
              docentes, egresados y comunidad académica policial, contribuyendo
              a los avances de la acreditación de nuestros programas académicos.
            </p>
            <p>
              La Revista, mantiene una convocatoria abierta durante el año para
              que nuestros{" "}
              <b>
                estudiantes y docentes, así como a nuestra comunidad de
                egresados de la ESCPOGRA, puedan enviar sus artículos de opinión
                y/o ensayos sobre problemáticas institucionales, con el fin de
                promover el debate desde el campo académico.
              </b>
            </p>
            <div>
              <p>
                Para remitir su artículo y/o ensayo, debe seguir las siguientes
                pautas:
              </p>
        ...
        <SubSectionBasic title="Ediciones" className="section-list">
          <CardList data={data} scroll={false} />
        </SubSectionBasic>
      </Container>
    </SectionBasic>
  );
